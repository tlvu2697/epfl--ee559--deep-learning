...
def main():
    ...
    w1 = torch.cuda.FloatTensor(nb_hidden, train_input.size(1)).normal_(0, epsilon)
    b1 = torch.cuda.FloatTensor(nb_hidden).normal_(0, epsilon)
    w2 = torch.cuda.FloatTensor(nb_classes, nb_hidden).normal_(0, epsilon)
    b2 = torch.cuda.FloatTensor(nb_classes).normal_(0, epsilon)

    dl_dw1 = torch.cuda.FloatTensor(w1.size())
    dl_db1 = torch.cuda.FloatTensor(b1.size())
    dl_dw2 = torch.cuda.FloatTensor(w2.size())
    dl_db2 = torch.cuda.FloatTensor(b2.size())
